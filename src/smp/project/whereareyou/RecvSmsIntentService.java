...
public class RecvSmsIntentService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		//String mess = intent.getStringExtra("sms_body");  //FIXME
		...
		resultIntent.putExtra("sms_number", intent.getStringExtra("sms_number"));
		resultIntent.putExtra("sms_ip", intent.getStringExtra("sms_ip"));
